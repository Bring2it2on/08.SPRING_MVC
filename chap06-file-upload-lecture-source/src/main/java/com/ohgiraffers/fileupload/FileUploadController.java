...
public class FileUploadController {
    ...
    public String singleFileUpload(@RequestParam MultipartFile singleFile,
        ...
        // 인텔리제이 root 폴더 지정
        Resource resource = resourceLoader.getResource("classpath:static/img/single"); // classpath: : 클래스의 resource 까지의 경로로 가져다 준다.
    ...
    public String multiFileUpload(@RequestParam List<MultipartFile> multiFiles,
        ...
        log.info("multiFilesDescription : {}", multiFileDescription);
